...
import com.marcosoft.uberclone10.activities.MainActivity;
import com.marcosoft.uberclone10.activities.driver.MapDriverActivity;
import com.marcosoft.uberclone10.includes.MyToolbar;
import com.marcosoft.uberclone10.models.Token;
...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private TokenProvider mTokenProviders;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTokenProviders = new TokenProvider();
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveDrivers(mCurrentLatLng,10.00).addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
    ...
    void generateToken(){
        mTokenProviders.create(mAuthProvider.getId());
    }
}
